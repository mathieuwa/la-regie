<!-- Copie d'export vendorisee, source : ads/references/meta-creative-specs.md du plugin claude-ads (marketplace agricidaniel-claude-ads). Ne se met pas a jour toute seule : a realigner manuellement si la reference source du plugin evolue. -->
