<!-- Copie d'export vendorisee, source : ads/references/brand-dna-template.md du plugin claude-ads (marketplace agricidaniel-claude-ads). Ne se met pas a jour toute seule : a realigner manuellement si la reference source du plugin evolue. -->
