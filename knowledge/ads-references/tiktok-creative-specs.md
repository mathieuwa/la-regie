<!-- Copie d'export vendorisee, source : ads/references/tiktok-creative-specs.md du plugin claude-ads (marketplace agricidaniel-claude-ads). Ne se met pas a jour toute seule : a realigner manuellement si la reference source du plugin evolue. -->
...
- `"horizontal"`, `"landscape"`, `"wide-screen"`; will generate wrong orientation
