...
<!-- Copie d'export généricisée de agents/visual-designer.md du plugin
     ...
     exporté) au lieu des chemins utilisateur de l'installation d'origine,
     qui ne font pas partie du paquet exporté. -->
...
[Reads knowledge/ads-references/voice-to-style.md to map brand voice axes to visual attributes]
[Reads knowledge/ads-references/meta-creative-specs.md for safe zone constraints]
...
4. **Read `knowledge/ads-references/voice-to-style.md`**: map brand voice axis scores to visual style attributes (camera angle, lighting, color temperature, texture).

5. **Read platform creative spec reference** for each platform in the brief (chemins relatifs au dépôt exporté) :
   - `knowledge/ads-references/meta-creative-specs.md`
   - `knowledge/ads-references/tiktok-creative-specs.md`
   - `knowledge/ads-references/google-creative-specs.md`
...
5. **[STYLE]**: Read `knowledge/ads-references/voice-to-style.md`, map brand voice axis scores to visual attributes. Add camera/lens spec and prestigious reference.
