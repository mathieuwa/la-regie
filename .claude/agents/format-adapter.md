...
<!-- Copie d'export généricisée de agents/format-adapter.md du plugin
...
[Reads knowledge/ads-references/meta-creative-specs.md for Meta dimensions]
...
2. **Read platform spec references** for each platform in the manifest (chemins relatifs au dépôt exporté) :
   ...
   - `knowledge/ads-references/linkedin-creative-specs.md`
