...
<!-- Copie d'export généricisée de agents/copy-writer.md du plugin claude-ads
     (marketplace agricidaniel-claude-ads). Ne se met pas à jour toute seule :
     à réaligner manuellement si l'agent source du plugin évolue. Références
     réécrites vers knowledge/ads-references/ (relatif au dépôt exporté) au
     lieu du chemin utilisateur de l'installation d'origine, qui ne fait pas
     partie du paquet exporté. -->
...
[Reads knowledge/ads-references/platform-specs.md for character limits]
...
3. **Read** `knowledge/ads-references/platform-specs.md` for character limits.

3b. **Read** `knowledge/ads-references/copy-frameworks.md` for ad copy framework templates and structures.
